...
*/
        ...
        //$filter = array('EMPLID'=>'where/'.$this->get('EMPLID'), 'ATTENDANCEDATE' => 'order/desc', '', '');
        //$get_attendance = GetAll('HRSTMATTENDANCEDATA',$filter);
        $this->db->select('*,(CLOCKIN - 25200) AS MENIT_TELAT')->from('HRSTMATTENDANCEDATA');
        //$this->db->where('month(ATTENDANCEDATE)=05');
        $this->db->where('EMPLID', $this->get('EMPLID'));
        $this->db->where('CLOCKIN >', 25200);
        $this->db->order_by('ATTENDANCEDATE', 'DESC');
        $this->db->limit(366);
        $get_attendance = $this->db->get();
        $user = $get_attendance->result_array();
...
*/
        ...
        //$filter = array('EMPLID'=>'where/'.$this->get('EMPLID'), 'ATTENDANCEDATE' => 'order/desc', '', '');
        //$get_attendance = GetAll('HRSTMATTENDANCEDATA',$filter);
        $this->db->select('SUM(CLOCKIN - 25200) AS JUMLAH_MENIT_TELAT')->from('HRSTMATTENDANCEDATA');
        //$this->db->where('month(ATTENDANCEDATE)=05');
        $this->db->where('EMPLID', $this->get('EMPLID'));
        $this->db->where('CLOCKIN >', 25200);
        //$this->db->order_by('ATTENDANCEDATE', 'DESC');
    ...
    function user_jumlah_telat_get()
    {
        if(!$this->get('EMPLID'))
        {
            $this->response(NULL, 400);
...
*/
        ...
        //$filter = array('EMPLID'=>'where/'.$this->get('EMPLID'), 'ATTENDANCEDATE' => 'order/desc', '', '');
        //$get_attendance = GetAll('HRSTMATTENDANCEDATA',$filter);
        $this->db->select('COUNT(CLOCKIN - 25200) AS JUMLAH_HARI_TELAT')->from('HRSTMATTENDANCEDATA');
        //$this->db->where('month(ATTENDANCEDATE)=05');
        $this->db->where('EMPLID', $this->get('EMPLID'));
        $this->db->where('CLOCKIN >', 25200);
        //$this->db->order_by('ATTENDANCEDATE', 'DESC');
